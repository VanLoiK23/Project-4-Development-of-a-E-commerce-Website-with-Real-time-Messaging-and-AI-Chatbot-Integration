			...
			<div class="table" style="margin-top: 50px;">
				<div class="table-header">
					<button style="background: orange; scale: calc(0.9);">
						<a style="color: white"
							href="<c:url value='/quan-tri/supplier/danh-sach'/>"><i
				...
				<div class="table-section">
					<table>
						...
						<tr>
							...
							<th style="width: 160px;">Tên nhà cung cấp</th>
									...
									<c:forEach var="item" items="${model.listResult}" varStatus="i">
										<tr style='color: black'>
											...
											<td>
												<button>
													<a style='color: white'
														href='http://localhost:8080/Spring-mvc/quan-tri/supplier/reset/${item.id}'>
