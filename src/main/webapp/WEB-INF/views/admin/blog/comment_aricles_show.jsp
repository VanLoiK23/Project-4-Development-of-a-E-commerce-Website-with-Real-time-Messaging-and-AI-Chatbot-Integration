	...
	<div class="main-content">
		...
		<div class="p-4" id="edit_sp">
			<div class="table" style="padding: 0 !important;">
				<form
					action="http://localhost:8080/Spring-mvc/quan-tri/QuanlicommentArticles_controller/show_content/${dto.id}"
					method="POST">
						...
						<p>
							<button type="button"
								...
								<a style="color: white; text-decoration: none;"
									href="http://localhost:8080/Spring-mvc/quan-tri/QuanlicommentArticles_controller/danh-sach"><i
							...
							<div class="form-group">
								<div>
									...
									<c:forEach var="j" begin="1" end="5">
										<c:choose>
											<c:when test="${j <= dto.rating}">
												<i style="color: #FFD700;" class="fa-solid fa-star"></i>
											</c:when>
											<c:when test="${j - 0.5 <= dto.rating&& j > dto.rating}">
							...
							<div class="form-group">
								<div>
									...
									<textarea style="width: 530px !important; height: 100px;"
										...
										name="feeback_content" required>${dto.contentFeedback}</textarea>
									...
									<button type="submit" name="submit"
										...
										<c:if test="${dto.feedback==1 }">
                                            Cập nhật phản hồi
                                            </c:if>
										<c:if test="${dto.feedback==0 }">
                                            Gửi phản hồi
                                            </c:if>
									</button>
								</div>
