			...
			<div class="table" style="margin-top: 50px;">
				<div class="table-header">
					<button style="background: orange; scale: calc(0.9);">
						<a style="color: white" href="http://localhost:8080/Spring-mvc/quan-tri/phieunhap/danh-sach"><i
								...
								<c:when test="${not empty model.listResult}">
									...
									<c:forEach var="item" items="${model.listResult}" varStatus="i">
										<tr style='color: black'>
											...
											<td>${item.id }</td>
											<td
												style='white-space: nowrap; overflow: hidden; text-overflow: ellipsis;'>${item.nhaCungCapName}</td>
											...
											<td>
												<button>
													<a style='color: white'
														href='http://localhost:8080/Spring-mvc/quan-tri/phieunhap/reset/${item.id}'>
