...
<!-- Modal Container (Form Thông Tin Phiếu Nhập) -->
<div class="modal-container">
	...
	<!-- Dòng thông tin phiếu nhập -->
	<div class="info-row">
		<div class="form-group">
			<label for="voucherCode">Mã Phiếu:</label> <input type="text"
				class="form-control" id="voucherCode" value="PN001" readonly>
		</div>
		<div class="form-group">
			<label for="employee">Nhân viên nhập:</label> <input type="text"
				class="form-control" id="employee" value="Nguyễn Văn A" readonly>
		</div>
		<div class="form-group">
			<label for="supplier">Nhà cung cấp:</label> <input type="text"
				class="form-control" id="supplier" value="Công ty ABC" readonly>
		</div>
		<div class="form-group">
			<label for="createTime">Thời gian tạo:</label> <input type="text"
				class="form-control" id="createTime" value="2024-11-12 10:00"
				readonly>
		</div>
	</div>
