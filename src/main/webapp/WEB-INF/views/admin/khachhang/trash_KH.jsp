			...
			<div class="table" style="margin-top: 50px;">
				<div class="table-header">
					<button style="background: orange; scale: calc(0.9);">
						<a style="color: white"
							href="<c:url value='/quan-tri/Quanlikhachhang_controller/danh-sach'/>"><i
									...
									<c:forEach var="item" items="${model.listResult}" varStatus="i">
										...
										<tr style="color: black">
											...
											<td>
												<button>
													<a style='color: white'
														href='http://localhost:8080/Spring-mvc/quan-tri/Quanlikhachhang_controller/reset/${item.id }'>
														<i class='fa-solid fa-arrows-rotate'></i>
													</a>
												</button>
												<!-- <button alt='Xóa vĩnh viễn'>
													<a style='color: white'http://localhost:8080/Spring-mvc/quan-tri/Quanlikhachhang_controller/Delete_permanent/${item.id }'>
